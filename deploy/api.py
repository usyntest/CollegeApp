...
class GithubApp:
    ...
    def create_deployment(self, owner, repository, branch="main", description="", environment="production",
                          is_production=True):
        endpoint = self.endpoint(f"repos/{owner}/{repository}/deployments")
        data = json.dumps({
            "ref": branch, "description": description, "environment": environment,
